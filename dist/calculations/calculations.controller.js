...
__decorate([
    (0, common_1.Post)(),
    (0, swagger_1.ApiOperation)({ summary: 'Save a new calculation' }),
    (0, swagger_1.ApiResponse)({ status: 201, description: 'The calculation has been successfully saved.' }),
...
__decorate([
    (0, common_1.Get)(),
    (0, swagger_1.ApiOperation)({ summary: 'Get recent calculation history' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Return all recent calculations.' }),
    __metadata("design:type", Function),
